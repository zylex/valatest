/* valatest.c generated by valac 0.20.1, the Vala compiler
 * generated from valatest.vala, do not modify */
...
GQuark vala_test_assertion_error_quark (void) {
	return g_quark_from_static_string ("vala_test_assertion_error-quark");
}
...
void vala_test_assert_true (gboolean condition, const gchar* message, GError** error) {
	...
	if (!_tmp0_) {
		const gchar* _tmp1_;
		_tmp1_ = message;
		vala_test_fail (_tmp1_, &_inner_error_);
		if (_inner_error_ != NULL) {
			if (_inner_error_->domain == VALA_TEST_ASSERTION_ERROR) {
...
void vala_test_assert_null (GObject* obj, const gchar* message, GError** error) {
	...
	_tmp0_ = obj;
	_tmp1_ = message;
	vala_test_assert_true (_tmp0_ == NULL, _tmp1_, &_inner_error_);
	if (_inner_error_ != NULL) {
		if (_inner_error_->domain == VALA_TEST_ASSERTION_ERROR) {
			g_propagate_error (error, _inner_error_);
			return;
...
void vala_test_fail (const gchar* message, GError** error) {
	...
	g_return_if_fail (message != NULL);
	_tmp0_ = message;
	_tmp1_ = g_error_new_literal (VALA_TEST_ASSERTION_ERROR, VALA_TEST_ASSERTION_ERROR_ASSERTION_FAILED, _tmp0_);
